"""este programa utiliza la API de OpenAI para crear un chatbot con el modelo GPT-3"""
import argparse
import openai
...
conversation_buffer = []
#función que imprimir el contenido de la consulta o la respuesta
def print_message(message, is_user_message=True):
    """Imprime el contenido de la consulta o la respuesta"""
...
while args.convers:
    ...
    #si la consulta es nula, se ignora y se vuelve a pedi
    if not user_input:
        continue
